...
Rainbow.extend('tamescript', [
    ...
    {
        name: 'keyword',
        pattern: /\b(if|else|while|for|quit|end|break|continue|module|world|room|player|object|container|action|general|modal|transitive|ditransitive|open|restricted|named|tagged|modes|uses|conjunctions|determiners|forbids|allows|local|clear|archetype|function|return|this|override|extend|strict)\b/gi
    },
    {
        name: 'command',
    ...
    {
        name: 'entry',
        pattern: /\b(INIT|AFTER(SUCCESSFUL|FAILED|EVERY)COMMAND|START|ON(ACTION(WITH(OTHER|ANCESTOR)?)?|MODALACTION|WORLDBROWSE|ROOMBROWSE|PLAYERBROWSE|CONTAINERBROWSE|AMBIGUOUSCOMMAND|MALFORMEDCOMMAND|INCOMPLETECOMMAND|UNKNOWNCOMMAND|UNHANDLEDACTION|FORBIDDENACTION|ROOMFORBIDDENACTION))\b/gi
    },
    {
